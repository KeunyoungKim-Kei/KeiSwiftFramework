...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "A short description of KeiSwiftFramework."
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/KeiSwiftFramework"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Keun young Kim" => "app@meetkei.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/KeiSwiftFramework.git", :tag => s.version.to_s }
